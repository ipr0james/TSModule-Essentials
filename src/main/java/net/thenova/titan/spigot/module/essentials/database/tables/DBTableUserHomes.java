 ...
 */
public final class DBTableUserHomes extends DatabaseTable {

    public DBTableUserHomes() {
        super("user_homes", new DatabaseEssentials());
    }
    ...
    public void init() {
        registerColumn(
                ...
                new TableColumn("home_name", new VarChar(VarChar.LENGTH_DEFAULT)).setNullable(false),
                new TableColumn("home_location", new Text()).setNullable(false).setDefault(0)
        );
    }
}
